...
- Residual studies analyzed: 7

## Category Counts

- unknown_type_and_no_raw_data: 3
- far_miss_gt_20pct: 2
- missing_expected_effect_family: 2

## Prioritized Fix Plan

- P1 | unknown_type_and_no_raw_data (3): Add fallback type inference from outcome text (e.g., death/dropout/adverse event => binary) and confidence penalties when only incompatible effect families are present.
