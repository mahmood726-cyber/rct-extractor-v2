...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Jin_2016 | 10.1371/journal.pone.0166181 | plos_one | yes | yes | yes | full_auto | no | 8 |
| Oyo-Ita_2021 | 10.1371/journal.pone.0248236 | plos_one | yes | yes | yes | full_auto | no | 2 |
| Yan_2021 | 10.1371/journal.pmed.1003582 | plos_pmed | yes | yes | n/a | manual | yes | 2 |

## Notes

- `plos_one` is strictly DOI prefix `10.1371/journal.pone.`
- Any `10.1371/journal.*` DOI not matching `journal.pone.` is tracked as non-PLOS-ONE.
