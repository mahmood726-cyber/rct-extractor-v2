...
- Generated UTC: 2026-02-20T11:23:44.264452+00:00
...
| strict_match_rate | 81.8% | 81.8% | 0.0% |
| lenient_match_rate | 90.9% | 90.9% | 0.0% |
...
- PDF-only status counts: {'approximate_match': 1, 'close_match': 2, 'distant_match': 1, 'exact_match': 2, 'exact_match_with_ci': 5}
- PDF+PubMed status counts: {'approximate_match': 1, 'close_match': 2, 'distant_match': 1, 'exact_match': 2, 'exact_match_with_ci': 5}

## Bootstrap 95% CI (Validated Cohort, PDF Only)

- extraction_coverage: 100.0% (100.0% to 100.0%)
- strict_match_rate: 81.8% (54.5% to 100.0%)
- lenient_match_rate: 90.9% (72.7% to 100.0%)
...
| polo_2019 | distant_match | 0.360441 | 0.53 [0.35, 0.82] | HR 0.76 [0.46, 1.23] | Likely endpoint/timepoint mismatch | Extracted HR=0.76 (CI 0.46-1.23) differs from gold HR=0.53; likely different endpoint/analysis set. | Tighten context matching to gold outcome phrase and prioritize confidence-interval-consistent candidates. |
