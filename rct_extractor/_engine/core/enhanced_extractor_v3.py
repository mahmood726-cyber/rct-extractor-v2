...
class EnhancedExtractor:
    ...
    def normalize_text(self, text: str) -> str:
        ...
        # keyword and its lower bound ("95% CI ¼ 1.03 to 1.54"), observed in an
        # obesity RCT where the point's "HR ¼" was repaired above but the CI's
        # "¼" was not, dropping the whole interval. Repair it in the CI-keyword
        # position too, only when immediately followed by a number (so a real
        # "¼" is never rewritten).
