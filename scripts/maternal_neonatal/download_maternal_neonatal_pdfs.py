"""
Download OA maternal/neonatal RCT PDFs (reuses the malaria PMC-OA downloader,
maternal/neonatal paths).

Usage:
  python scripts/maternal_neonatal/download_maternal_neonatal_pdfs.py --workers 3 --batch 5000 --resume
"""
import argparse
import io
import json
...
MNH_DIR = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "maternal_neonatal"
MATCHED = MNH_DIR / "maternal_neonatal_matched.jsonl"
PDF_DIR = MNH_DIR / "rct_trial_pdfs"
LOG = MNH_DIR / "download_log.jsonl"
