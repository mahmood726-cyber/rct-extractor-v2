"""
Maternal/neonatal unified cross-check: per trial reconcile PDF extractions vs
PubMed abstract vs AACT (when NCT). Abstract->PDF recall is the at-scale signal;
AACT->PDF is the independent numeric gold.

Outputs: data/field_portability/maternal_neonatal/cross_check.json
Usage: python scripts/maternal_neonatal/cross_check.py --limit 0
"""
import argparse
import io
import json
...
AACT_GOLD = MNH / "aact_maternal_neonatal_gold.json"
PDF_DIR = MNH / "rct_trial_pdfs"
OUT = MNH / "cross_check.json"
