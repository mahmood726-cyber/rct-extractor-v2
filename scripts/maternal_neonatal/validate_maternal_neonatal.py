"""
Maternal & neonatal extractor validation on the corpus: extraction yield, 2x2 /
continuous yield, and internal-consistency rate over abstracts (and PDFs with
--pdfs).

Usage:
  python scripts/maternal_neonatal/validate_maternal_neonatal.py --limit 5000
  python scripts/maternal_neonatal/validate_maternal_neonatal.py --pdfs    # use downloaded full-text PDFs
"""
import argparse
import io
import json
...
PDF_DIR = MNH / "rct_trial_pdfs"
OUT = MNH / "validation.json"
...
def main():
    ...
    eff_consistent = 0
    types = Counter(); mnh_subspec = Counter()
    ...
    res = {
        ...
        "maternal_neonatal_subspecialty": dict(mnh_subspec.most_common()),
        "arm_level": {
            "proportions": n_props,
