"""
Mine the published-maternal/neonatal-MA misses: effect estimates the reviewers
reported that our extractor did NOT recover, with snippets, to reveal fixable
format gaps.

Usage: python scripts/maternal_neonatal/analyze_maternal_neonatal_ma_misses.py --retmax 250 --email you@org
"""
import argparse
import io
import json
...
from scripts.maternal_neonatal.validate_maternal_neonatal_ma import MNH_MA_TERM

OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "maternal_neonatal" / "ma_misses.jsonl"
