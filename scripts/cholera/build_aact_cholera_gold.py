"""
Build an AACT gold file of cholera trial effect estimates (reuses the malaria
AACT dialect + param_type normalization). Many cholera trials register on ISRCTN
/ CTRI / PACTR rather than ClinicalTrials.gov, so this gold may be sparser than
HIV's.

Usage:
  python scripts/cholera/build_aact_cholera_gold.py --aact "F:/AACT-storage/AACT/2026-04-12"
"""
import argparse
import io
import json
...
OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "cholera" / "aact_cholera_gold.json"
