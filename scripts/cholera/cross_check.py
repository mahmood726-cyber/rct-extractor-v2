"""
Cholera unified cross-check: per trial reconcile PDF extractions vs PubMed
abstract vs AACT (when NCT). Abstract->PDF recall is the at-scale signal;
AACT->PDF is the independent numeric gold (sparse for cholera).

Outputs: data/field_portability/cholera/cross_check.json
Usage: python scripts/cholera/cross_check.py --limit 0
"""
import argparse
import io
import json
...
AACT_GOLD = CHOLERA / "aact_cholera_gold.json"
PDF_DIR = CHOLERA / "rct_trial_pdfs"
OUT = CHOLERA / "cross_check.json"
