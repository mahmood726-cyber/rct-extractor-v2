"""
Download OA cholera RCT PDFs (reuses the malaria PMC-OA downloader, cholera paths).

Usage:
  python scripts/cholera/download_cholera_pdfs.py --workers 3 --batch 3000 --resume
"""
import argparse
import io
import json
...
CHOLERA_DIR = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "cholera"
MATCHED = CHOLERA_DIR / "cholera_matched.jsonl"
PDF_DIR = CHOLERA_DIR / "rct_trial_pdfs"
LOG = CHOLERA_DIR / "download_log.jsonl"
