"""
Mine the published-cholera-MA misses: effect estimates the reviewers reported
that our extractor did NOT recover, with snippets, to reveal fixable format gaps.

Usage: python scripts/cholera/analyze_cholera_ma_misses.py --retmax 200 --email you@org
"""
import argparse
import io
import json
...
from scripts.cholera.validate_cholera_ma import CHOLERA_MA_TERM

OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "cholera" / "ma_misses.jsonl"
