"""
Schistosomiasis unified cross-check: per trial reconcile PDF extractions vs PubMed
abstract vs AACT (when NCT). Abstract->PDF recall is the at-scale signal;
AACT->PDF is the independent numeric gold (sparse for schistosomiasis).

Outputs: data/field_portability/schistosomiasis/cross_check.json
Usage: python scripts/schistosomiasis/cross_check.py --limit 0
"""
import argparse
import io
import json
...
AACT_GOLD = SCHISTO / "aact_schistosomiasis_gold.json"
PDF_DIR = SCHISTO / "rct_trial_pdfs"
OUT = SCHISTO / "cross_check.json"
