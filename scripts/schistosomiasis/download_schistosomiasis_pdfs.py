"""
Download OA schistosomiasis RCT PDFs (reuses the malaria PMC-OA downloader,
schistosomiasis paths).

Usage:
  python scripts/schistosomiasis/download_schistosomiasis_pdfs.py --workers 3 --batch 4000 --resume
"""
import argparse
import io
import json
...
SCHISTO_DIR = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "schistosomiasis"
MATCHED = SCHISTO_DIR / "schistosomiasis_matched.jsonl"
PDF_DIR = SCHISTO_DIR / "rct_trial_pdfs"
LOG = SCHISTO_DIR / "download_log.jsonl"
