"""
Build an AACT gold file of schistosomiasis trial effect estimates (reuses the
malaria AACT dialect + param_type normalization). Many schistosomiasis trials
register on ISRCTN / PACTR rather than ClinicalTrials.gov, so this gold may be
sparser than HIV's.

Usage:
  python scripts/schistosomiasis/build_aact_schistosomiasis_gold.py --aact "F:/AACT-storage/AACT/2026-04-12"
"""
import argparse
import io
import json
...
OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "schistosomiasis" / "aact_schistosomiasis_gold.json"
