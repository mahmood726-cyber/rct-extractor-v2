"""
Mine the published-schistosomiasis-MA misses: effect estimates the reviewers
reported that our extractor did NOT recover, with snippets, to reveal fixable
format gaps.

Usage: python scripts/schistosomiasis/analyze_schistosomiasis_ma_misses.py --retmax 250 --email you@org
"""
import argparse
import io
import json
...
from scripts.schistosomiasis.validate_schistosomiasis_ma import SCHISTO_MA_TERM

OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "schistosomiasis" / "ma_misses.jsonl"
