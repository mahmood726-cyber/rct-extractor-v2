"""
HIV unified cross-check: per trial reconcile PDF extractions vs PubMed abstract
vs AACT (when NCT). Abstract->PDF recall is the at-scale signal; AACT->PDF is the
independent numeric gold (rich for HIV).

Outputs: data/field_portability/hiv/cross_check.json
Usage: python scripts/hiv/cross_check.py --limit 0
"""
import argparse
import io
import json
...
AACT_GOLD = HIV / "aact_hiv_gold.json"
PDF_DIR = HIV / "rct_trial_pdfs"
OUT = HIV / "cross_check.json"
