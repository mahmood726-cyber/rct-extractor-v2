"""
Mine the published-HIV-MA misses: effect estimates the reviewers reported that
our extractor did NOT recover, with snippets, to reveal fixable format gaps.

Usage: python scripts/hiv/analyze_hiv_ma_misses.py --retmax 200 --email you@org
"""
import argparse
import io
import json
...
from scripts.hiv.validate_hiv_ma import HIV_MA_TERM

OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "hiv" / "ma_misses.jsonl"
