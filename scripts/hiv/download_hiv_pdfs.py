"""
Download OA HIV RCT PDFs (reuses the malaria PMC-OA downloader, HIV paths).

Usage:
  python scripts/hiv/download_hiv_pdfs.py --workers 3 --batch 3000 --resume
"""
import argparse
import io
import json
...
HIV_DIR = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "hiv"
MATCHED = HIV_DIR / "hiv_matched.jsonl"
PDF_DIR = HIV_DIR / "rct_trial_pdfs"
LOG = HIV_DIR / "download_log.jsonl"
