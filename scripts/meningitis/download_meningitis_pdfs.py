"""
Download OA meningitis RCT PDFs (reuses the malaria PMC-OA downloader, meningitis paths).

Usage:
  python scripts/meningitis/download_meningitis_pdfs.py --workers 3 --batch 4000 --resume
"""
import argparse
import io
import json
...
MENINGITIS_DIR = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "meningitis"
MATCHED = MENINGITIS_DIR / "meningitis_matched.jsonl"
PDF_DIR = MENINGITIS_DIR / "rct_trial_pdfs"
LOG = MENINGITIS_DIR / "download_log.jsonl"
