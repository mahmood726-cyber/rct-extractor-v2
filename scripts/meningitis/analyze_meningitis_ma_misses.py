"""
Mine the published-meningitis-MA misses: effect estimates the reviewers reported
that our extractor did NOT recover, with snippets, to reveal fixable format gaps.

Usage: python scripts/meningitis/analyze_meningitis_ma_misses.py --retmax 250 --email you@org
"""
import argparse
import io
import json
...
from scripts.meningitis.validate_meningitis_ma import MENINGITIS_MA_TERM

OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "meningitis" / "ma_misses.jsonl"
