"""
Download OA sickle cell RCT PDFs (reuses the malaria PMC-OA downloader, SCD paths).

Usage:
  python scripts/sickle_cell/download_sickle_cell_pdfs.py --workers 3 --batch 6000 --resume
"""
import argparse
import io
import json
...
SCD_DIR = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "sickle_cell"
MATCHED = SCD_DIR / "sickle_cell_matched.jsonl"
PDF_DIR = SCD_DIR / "rct_trial_pdfs"
LOG = SCD_DIR / "download_log.jsonl"
