"""
Mine the published-sickle-cell-MA misses: effect estimates the reviewers reported
that our extractor did NOT recover, with snippets, to reveal fixable format gaps.

Usage: python scripts/sickle_cell/analyze_sickle_cell_ma_misses.py --retmax 300 --email you@org
"""
import argparse
import io
import json
...
from scripts.sickle_cell.validate_sickle_cell_ma import SICKLE_CELL_MA_TERM

OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "sickle_cell" / "ma_misses.jsonl"
