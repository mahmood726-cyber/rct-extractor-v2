"""
Sickle cell unified cross-check: per trial reconcile PDF extractions vs PubMed
abstract vs AACT (when NCT). Abstract->PDF recall is the at-scale signal;
AACT->PDF is the independent numeric gold.

Outputs: data/field_portability/sickle_cell/cross_check.json
Usage: python scripts/sickle_cell/cross_check.py --limit 0
"""
import argparse
import io
import json
...
AACT_GOLD = SCD / "aact_sickle_cell_gold.json"
PDF_DIR = SCD / "rct_trial_pdfs"
OUT = SCD / "cross_check.json"
