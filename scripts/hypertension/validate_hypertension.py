"""
Hypertension extractor validation on the corpus: extraction yield, 2x2 / continuous
...
Usage:
  ...
  python scripts/hypertension/validate_hypertension.py --pdfs   # use downloaded full-text PDFs
"""
import argparse
import io
import json
...
from rct_extractor._engine.specialties.hypertension_arm_data import extract_arm_level
...
def main():
    ...
    eff_consistent = 0
    types = Counter(); htn_subspec = Counter()
    ...
    res = {
        ...
        "hypertension_subspecialty": dict(htn_subspec.most_common()),
        "arm_level": {
            "proportions": n_props,
