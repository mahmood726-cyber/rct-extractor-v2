"""
Download OA hypertension RCT PDFs (reuses the malaria PMC-OA downloader, HTN paths).

Usage:
  python scripts/hypertension/download_hypertension_pdfs.py --workers 3 --batch 4000 --resume
"""
import argparse
import io
import json
...
HTN_DIR = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "hypertension"
MATCHED = HTN_DIR / "hypertension_matched.jsonl"
PDF_DIR = HTN_DIR / "rct_trial_pdfs"
LOG = HTN_DIR / "download_log.jsonl"
