"""
Download OA type-2 diabetes RCT PDFs (reuses the malaria PMC-OA downloader,
diabetes paths).

Usage:
  python scripts/diabetes/download_diabetes_pdfs.py --workers 3 --batch 3000 --resume
"""
import argparse
import io
import json
...
DIABETES_DIR = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "diabetes"
MATCHED = DIABETES_DIR / "diabetes_matched.jsonl"
PDF_DIR = DIABETES_DIR / "rct_trial_pdfs"
LOG = DIABETES_DIR / "download_log.jsonl"
