"""
Mine the published-diabetes-MA misses: effect estimates the reviewers reported
that our extractor did NOT recover, with snippets, to reveal fixable format gaps.

Usage: python scripts/diabetes/analyze_diabetes_ma_misses.py --retmax 200 --email you@org
"""
import argparse
import io
import json
...
from scripts.diabetes.validate_diabetes_ma import DIABETES_MA_TERM

OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "diabetes" / "ma_misses.jsonl"
