"""
Build the lymphatic filariasis (LF / elephantiasis) RCT corpus index from PubMed
(reuses the malaria corpus helpers).

Output: data/field_portability/lymphatic_filariasis/lymphatic_filariasis_matched.jsonl
...
OUT_DIR = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "lymphatic_filariasis"
OUT_FILE = OUT_DIR / "lymphatic_filariasis_matched.jsonl"

LF_TERM = (
    '("lymphatic filariasis"[Title/Abstract] OR filariasis[Title/Abstract] OR '
    'wuchereria[Title/Abstract] OR brugia[Title/Abstract] OR '
    'microfilaraemia[Title/Abstract] OR microfilaremia[Title/Abstract] OR '
    'microfilaria[Title/Abstract] OR diethylcarbamazine[Title/Abstract] OR '
    'elephantiasis[Title/Abstract] OR "circulating filarial antigen"[Title/Abstract]) '
...
def main():
    ap = argparse.ArgumentParser(description="Build LF RCT corpus index")
    ap.add_argument("--term", default=LF_TERM)
    ...
    print(f"esearch lymphatic-filariasis RCTs (retmax={args.retmax})...")
