"""
Download OA diarrhoeal RCT PDFs (reuses the malaria PMC-OA downloader,
diarrhoeal paths).

Usage:
  python scripts/diarrhoeal/download_diarrhoeal_pdfs.py --workers 3 --batch 3000 --resume
"""
import argparse
import io
import json
...
DIARRHOEAL_DIR = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "diarrhoeal"
MATCHED = DIARRHOEAL_DIR / "diarrhoeal_matched.jsonl"
PDF_DIR = DIARRHOEAL_DIR / "rct_trial_pdfs"
LOG = DIARRHOEAL_DIR / "download_log.jsonl"
