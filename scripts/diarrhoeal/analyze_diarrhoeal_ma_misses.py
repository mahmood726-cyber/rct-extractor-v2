"""
Mine the published-diarrhoeal-MA misses: effect estimates the reviewers reported
that our extractor did NOT recover, with snippets, to reveal fixable format gaps.

Usage: python scripts/diarrhoeal/analyze_diarrhoeal_ma_misses.py --retmax 250 --email you@org
"""
import argparse
import io
import json
...
from scripts.diarrhoeal.validate_diarrhoeal_ma import DIARRHOEAL_MA_TERM

OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "diarrhoeal" / "ma_misses.jsonl"
