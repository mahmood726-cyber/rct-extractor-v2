"""
Diarrhoeal unified cross-check: per trial reconcile PDF extractions vs PubMed
abstract vs AACT (when NCT). Abstract->PDF recall is the at-scale signal;
AACT->PDF is the independent numeric gold (sparse for diarrhoeal LMIC trials).

Outputs: data/field_portability/diarrhoeal/cross_check.json
Usage: python scripts/diarrhoeal/cross_check.py --limit 0
"""
import argparse
import io
import json
...
AACT_GOLD = DIARRHOEAL / "aact_diarrhoeal_gold.json"
PDF_DIR = DIARRHOEAL / "rct_trial_pdfs"
OUT = DIARRHOEAL / "cross_check.json"
