"""
Mine the published-leishmaniasis-MA misses: effect estimates the reviewers
reported that our extractor did NOT recover, with snippets, to reveal fixable
format gaps.

Usage: python scripts/leishmaniasis/analyze_leishmaniasis_ma_misses.py --retmax 250 --email you@org
"""
import argparse
import io
import json
...
from scripts.leishmaniasis.validate_leishmaniasis_ma import LEISH_MA_TERM

OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "leishmaniasis" / "ma_misses.jsonl"
