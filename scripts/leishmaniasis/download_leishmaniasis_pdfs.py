"""
Download OA leishmaniasis RCT PDFs (reuses the malaria PMC-OA downloader,
leishmaniasis paths).

Usage:
  python scripts/leishmaniasis/download_leishmaniasis_pdfs.py --workers 3 --batch 4000 --resume
"""
import argparse
import io
import json
...
LEISH_DIR = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "leishmaniasis"
MATCHED = LEISH_DIR / "leishmaniasis_matched.jsonl"
PDF_DIR = LEISH_DIR / "rct_trial_pdfs"
LOG = LEISH_DIR / "download_log.jsonl"
