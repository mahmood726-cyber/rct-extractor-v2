"""
Build an AACT gold file of trachoma trial effect estimates (reuses the malaria
AACT dialect + param_type normalization). Many trachoma trials register on
ISRCTN / PACTR rather than ClinicalTrials.gov, so this gold may be sparser than
HIV's.

Usage:
  python scripts/trachoma/build_aact_trachoma_gold.py --aact "F:/AACT-storage/AACT/2026-04-12"
"""
import argparse
import io
import json
...
OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "trachoma" / "aact_trachoma_gold.json"
