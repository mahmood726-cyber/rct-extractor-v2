"""
Trachoma unified cross-check: per trial reconcile PDF extractions vs PubMed
abstract vs AACT (when NCT). Abstract->PDF recall is the at-scale signal;
AACT->PDF is the independent numeric gold (sparse for trachoma).

Outputs: data/field_portability/trachoma/cross_check.json
Usage: python scripts/trachoma/cross_check.py --limit 0
"""
import argparse
import io
import json
...
AACT_GOLD = TRACHOMA / "aact_trachoma_gold.json"
PDF_DIR = TRACHOMA / "rct_trial_pdfs"
OUT = TRACHOMA / "cross_check.json"
