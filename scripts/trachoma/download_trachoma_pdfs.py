"""
Download OA trachoma RCT PDFs (reuses the malaria PMC-OA downloader, trachoma
paths).

Usage:
  python scripts/trachoma/download_trachoma_pdfs.py --workers 3 --batch 4000 --resume
"""
import argparse
import io
import json
...
TRACHOMA_DIR = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "trachoma"
MATCHED = TRACHOMA_DIR / "trachoma_matched.jsonl"
PDF_DIR = TRACHOMA_DIR / "rct_trial_pdfs"
LOG = TRACHOMA_DIR / "download_log.jsonl"
