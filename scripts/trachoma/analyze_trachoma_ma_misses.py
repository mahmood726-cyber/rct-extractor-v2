"""
Mine the published-trachoma-MA misses: effect estimates the reviewers reported
that our extractor did NOT recover, with snippets, to reveal fixable format gaps.

Usage: python scripts/trachoma/analyze_trachoma_ma_misses.py --retmax 250 --email you@org
"""
import argparse
import io
import json
...
from scripts.trachoma.validate_trachoma_ma import TRACHOMA_MA_TERM

OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "trachoma" / "ma_misses.jsonl"
