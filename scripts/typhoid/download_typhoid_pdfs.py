"""
Download OA typhoid RCT PDFs (reuses the malaria PMC-OA downloader, typhoid paths).

Usage:
  python scripts/typhoid/download_typhoid_pdfs.py --workers 3 --batch 3000 --resume
"""
import argparse
import io
import json
...
TYPHOID_DIR = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "typhoid"
MATCHED = TYPHOID_DIR / "typhoid_matched.jsonl"
PDF_DIR = TYPHOID_DIR / "rct_trial_pdfs"
LOG = TYPHOID_DIR / "download_log.jsonl"
