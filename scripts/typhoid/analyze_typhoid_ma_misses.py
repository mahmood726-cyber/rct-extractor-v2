"""
Mine the published-typhoid-MA misses: effect estimates the reviewers reported
that our extractor did NOT recover, with snippets, to reveal fixable format gaps.

Usage: python scripts/typhoid/analyze_typhoid_ma_misses.py --retmax 200 --email you@org
"""
import argparse
import io
import json
...
from scripts.typhoid.validate_typhoid_ma import TYPHOID_MA_TERM

OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "typhoid" / "ma_misses.jsonl"
