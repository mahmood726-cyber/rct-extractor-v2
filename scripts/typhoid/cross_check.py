"""
Typhoid unified cross-check: per trial reconcile PDF extractions vs PubMed
abstract vs AACT (when NCT). Abstract->PDF recall is the at-scale signal;
AACT->PDF is the independent numeric gold (sparse for typhoid).

Outputs: data/field_portability/typhoid/cross_check.json
Usage: python scripts/typhoid/cross_check.py --limit 0
"""
import argparse
import io
import json
...
AACT_GOLD = TYPHOID / "aact_typhoid_gold.json"
PDF_DIR = TYPHOID / "rct_trial_pdfs"
OUT = TYPHOID / "cross_check.json"
