"""
Mine the published-onchocerciasis-MA misses: effect estimates the reviewers
reported that our extractor did NOT recover, with snippets, to reveal fixable
format gaps.

Usage: python scripts/onchocerciasis/analyze_onchocerciasis_ma_misses.py --retmax 250 --email you@org
"""
import argparse
import io
import json
...
from scripts.onchocerciasis.validate_onchocerciasis_ma import ONCHO_MA_TERM

OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "onchocerciasis" / "ma_misses.jsonl"
