"""
Download OA onchocerciasis RCT PDFs (reuses the malaria PMC-OA downloader,
onchocerciasis paths).

Usage:
  python scripts/onchocerciasis/download_onchocerciasis_pdfs.py --workers 3 --batch 4000 --resume
"""
import argparse
import io
import json
...
ONCHO_DIR = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "onchocerciasis"
MATCHED = ONCHO_DIR / "onchocerciasis_matched.jsonl"
PDF_DIR = ONCHO_DIR / "rct_trial_pdfs"
LOG = ONCHO_DIR / "download_log.jsonl"
