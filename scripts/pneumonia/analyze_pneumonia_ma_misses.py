"""
Mine the published-pneumonia-MA misses: effect estimates the reviewers reported
that our extractor did NOT recover, with snippets, to reveal fixable format gaps.

Usage: python scripts/pneumonia/analyze_pneumonia_ma_misses.py --retmax 250 --email you@org
"""
import argparse
import io
import json
...
from scripts.pneumonia.validate_pneumonia_ma import PNEUMONIA_MA_TERM

OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "pneumonia" / "ma_misses.jsonl"
