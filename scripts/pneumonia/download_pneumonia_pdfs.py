"""
Download OA childhood-pneumonia RCT PDFs (reuses the malaria PMC-OA downloader,
pneumonia paths).

Usage:
  python scripts/pneumonia/download_pneumonia_pdfs.py --workers 3 --batch 5000 --resume
"""
import argparse
import io
import json
...
PNEUMONIA_DIR = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "pneumonia"
MATCHED = PNEUMONIA_DIR / "pneumonia_matched.jsonl"
PDF_DIR = PNEUMONIA_DIR / "rct_trial_pdfs"
LOG = PNEUMONIA_DIR / "download_log.jsonl"
