"""
Mine the published cervical-cancer / HPV MA misses: effect estimates the reviewers
reported that our extractor did NOT recover, with snippets, to reveal fixable
format gaps.

Usage: python scripts/cervical_cancer/analyze_cervical_cancer_ma_misses.py --retmax 200 --email you@org
"""
import argparse
import io
import json
...
from scripts.cervical_cancer.validate_cervical_cancer_ma import CERVICAL_CANCER_MA_TERM

OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "cervical_cancer" / "ma_misses.jsonl"
