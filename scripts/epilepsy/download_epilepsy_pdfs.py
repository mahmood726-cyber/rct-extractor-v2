"""
Download OA epilepsy RCT PDFs (reuses the malaria PMC-OA downloader, epilepsy paths).

Usage:
  python scripts/epilepsy/download_epilepsy_pdfs.py --workers 3 --batch 3000 --resume
"""
import argparse
import io
import json
...
EPILEPSY_DIR = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "epilepsy"
MATCHED = EPILEPSY_DIR / "epilepsy_matched.jsonl"
PDF_DIR = EPILEPSY_DIR / "rct_trial_pdfs"
LOG = EPILEPSY_DIR / "download_log.jsonl"
