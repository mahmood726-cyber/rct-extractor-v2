"""
Mine the published-epilepsy-MA misses: effect estimates the reviewers reported
that our extractor did NOT recover, with snippets, to reveal fixable format gaps.

Usage: python scripts/epilepsy/analyze_epilepsy_ma_misses.py --retmax 200 --email you@org
"""
import argparse
import io
import json
...
from scripts.epilepsy.validate_epilepsy_ma import EPILEPSY_MA_TERM

OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "epilepsy" / "ma_misses.jsonl"
