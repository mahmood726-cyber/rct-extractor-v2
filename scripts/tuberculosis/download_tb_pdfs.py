"""
Download OA tuberculosis RCT PDFs (reuses the malaria PMC-OA downloader, TB paths).

Usage:
  python scripts/tuberculosis/download_tb_pdfs.py --workers 3 --batch 3000 --resume
"""
import argparse
import io
import json
...
TB_DIR = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "tuberculosis"
MATCHED = TB_DIR / "tuberculosis_matched.jsonl"
PDF_DIR = TB_DIR / "rct_trial_pdfs"
LOG = TB_DIR / "download_log.jsonl"
