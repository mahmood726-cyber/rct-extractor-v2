"""
TB unified cross-check: per trial reconcile PDF extractions vs PubMed abstract
vs AACT (when NCT). Abstract->PDF recall is the at-scale signal; AACT->PDF is the
independent numeric gold.

Outputs: data/field_portability/tuberculosis/cross_check.json
Usage: python scripts/tuberculosis/cross_check.py --limit 0
"""
import argparse
import io
import json
...
AACT_GOLD = TB / "aact_tb_gold.json"
PDF_DIR = TB / "rct_trial_pdfs"
OUT = TB / "cross_check.json"
