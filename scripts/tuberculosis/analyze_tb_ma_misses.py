"""
Mine the published-TB-MA misses: effect estimates the reviewers reported that
our extractor did NOT recover, with snippets, to reveal fixable format gaps.

Usage: python scripts/tuberculosis/analyze_tb_ma_misses.py --retmax 200 --email you@org
"""
import argparse
import io
import json
...
from scripts.tuberculosis.validate_tb_ma import TB_MA_TERM

OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "tuberculosis" / "ma_misses.jsonl"
