"""
Build the chronic-urticaria / anaphylaxis RCT corpus index from PubMed
(reuses malaria helpers).

Output: data/field_portability/urticaria/urticaria_matched.jsonl

Usage:
  python scripts/urticaria/build_urticaria_corpus.py --retmax 4000 --email you@org
"""
import argparse
import io
import json
...
OUT_DIR = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "urticaria"
OUT_FILE = OUT_DIR / "urticaria_matched.jsonl"

URTICARIA_TERM = (
    '("chronic spontaneous urticaria"[Title/Abstract] OR "chronic urticaria"[Title/Abstract] '
    'OR "chronic idiopathic urticaria"[Title/Abstract] OR "chronic inducible urticaria"[Title/Abstract] '
    'OR urticaria[Title/Abstract] OR anaphylaxis[Title/Abstract] '
    'OR "urticaria activity score"[Title/Abstract] OR UAS7[Title/Abstract] '
    'OR omalizumab[Title/Abstract] OR ligelizumab[Title/Abstract] OR remibrutinib[Title/Abstract] '
...
def main():
    ap = argparse.ArgumentParser(description="Build urticaria/anaphylaxis RCT corpus index")
    ap.add_argument("--term", default=URTICARIA_TERM)
    ...
    print(f"esearch urticaria/anaphylaxis RCTs (retmax={args.retmax})...")
