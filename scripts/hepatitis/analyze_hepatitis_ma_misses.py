"""
Mine the published-hepatitis-MA misses: effect estimates the reviewers reported
that our extractor did NOT recover, with snippets, to reveal fixable format gaps.

Usage: python scripts/hepatitis/analyze_hepatitis_ma_misses.py --retmax 200 --email you@org
"""
import argparse
import io
import json
...
from scripts.hepatitis.validate_hepatitis_ma import HEPATITIS_MA_TERM

OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "hepatitis" / "ma_misses.jsonl"
