"""
Download OA hepatitis RCT PDFs (reuses the malaria PMC-OA downloader, hepatitis paths).

Usage:
  python scripts/hepatitis/download_hepatitis_pdfs.py --workers 3 --batch 3000 --resume
"""
import argparse
import io
import json
...
HEP_DIR = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "hepatitis"
MATCHED = HEP_DIR / "hepatitis_matched.jsonl"
PDF_DIR = HEP_DIR / "rct_trial_pdfs"
LOG = HEP_DIR / "download_log.jsonl"
