"""
Hepatitis unified cross-check: per trial reconcile PDF extractions vs PubMed
abstract vs AACT (when NCT). Abstract->PDF recall is the at-scale signal;
AACT->PDF is the independent numeric gold (rich for HCV/HBV registration trials).

Outputs: data/field_portability/hepatitis/cross_check.json
Usage: python scripts/hepatitis/cross_check.py --limit 0
"""
import argparse
import io
import json
...
AACT_GOLD = HEP / "aact_hepatitis_gold.json"
PDF_DIR = HEP / "rct_trial_pdfs"
OUT = HEP / "cross_check.json"
