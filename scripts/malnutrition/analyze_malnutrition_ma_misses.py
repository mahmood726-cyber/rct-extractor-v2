"""
Mine the published-malnutrition-MA misses: effect estimates the reviewers reported
that our extractor did NOT recover, with snippets, to reveal fixable format gaps.

Usage: python scripts/malnutrition/analyze_malnutrition_ma_misses.py --retmax 200 --email you@org
"""
import argparse
import io
import json
...
from scripts.malnutrition.validate_malnutrition_ma import MALNUTRITION_MA_TERM

OUT = Path(__file__).resolve().parents[2] / "data" / "field_portability" / "malnutrition" / "ma_misses.jsonl"
