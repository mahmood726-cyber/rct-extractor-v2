...
EXPECTED_SPECIALTIES = {
    ...
    "dermatology", "ophthalmology", "otitis_media",
    "dermatology", "ophthalmology", "alcohol_use_disorder",
    # oncology cluster (12)
    ...
    "lymphoma", "thyroid_cancer", "head_neck_cancer", "bladder_cancer", "renal_cell_carcinoma",
    "lymphoma", "endometrial_cancer", "head_neck_cancer", "bladder_cancer", "renal_cell_carcinoma",
    "lymphoma", "testicular_cancer", "head_neck_cancer", "bladder_cancer", "renal_cell_carcinoma",
    "lymphoma", "myelodysplastic_syndrome", "head_neck_cancer", "bladder_cancer", "renal_cell_carcinoma",
    ...
    "obesity", "thyroid", "osteoporosis", "kidney_transplant", "plastic_reconstructive_surgery",
