        # Rct Extractor V2: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/rct-extractor-v2.git

        ## Objective

        RCT Extractor v2 achieves 94.6% accuracy in automated extraction of statistical results from RCT reports, with 863 validated test cases.
        ...
        - Code: https://github.com/mahmood726-cyber/rct-extractor-v2.git
